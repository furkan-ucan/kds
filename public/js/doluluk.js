...
FusionCharts.ready(function () {
    ...
    const roomTypes = [
        { id: 1, name: 'Standart Oda', containerId: 'chart-development-activity-1' },
        { id: 3, name: 'Suit Oda', containerId: 'chart-development-activity-2' },
        { id: 14, name: 'Deluxe Oda', containerId: 'chart-development-activity-3' },
        { id: 15, name: 'Aile Odası', containerId: 'chart-development-activity-4' },
        { id: 16, name: 'Ekonomik Oda', containerId: 'chart-development-activity-5' },
    ];
    ...
    roomTypes.forEach(roomType => {
        var myChart = new FusionCharts({
            ...
            dataSource: {
                chart: {
                    caption: `Gelecek 12 Tahmini Doluluk Oranı - ${roomType.name}`,
            ...
            .then(data => {
                ...
                const groupedData = filteredData.reduce((acc, item) => {
                    acc.push({
                        ...
                        toolText: `<b>${item.eski_doluluk_orani}%</b> Doluluk ${roomType.name} on ${new Date(item.tarih).toLocaleString('default', { month: 'long', year: 'numeric' })} <br/> `
                    });
                    return acc;
                }, []);
